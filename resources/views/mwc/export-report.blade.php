...
@section('content')
    <div class="w-full space-y-6">
        ...
        <div class="bg-white border border-zinc-200 rounded-3xl shadow-sm overflow-hidden">
            ...
            <div class="p-6">
                <form action="{{ route('mwc.export-report.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                    <div>
                ...
                <form id="export-form" action="{{ route('mwc.export-report.export') }}" method="POST" style="display: none;">
                    @csrf
